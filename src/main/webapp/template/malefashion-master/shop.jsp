...
<%@ page import="com.howard.rentalmytrack.dao.RentalMyTrackDaoImpl" %>
<%@ page import="java.util.List" %>
<%@ page import="com.howard.rentalmytrack.vo.RentalMyTrackVo" %>
<%@ page import="com.yu.rental.model.RentalDAOHibernateImpl" %>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="product__item sale">
                            <div class="product__item__pic set-bg" data-setbg="img/product/product-3.jpg">
                                ...
                                <ul class="product__hover">
                                    <li><a href="#" onclick="addTrack()"><img src="img/icon/heart.png" alt=""></a></li>
                                    <li><a href="#"><img src="img/icon/compare.png" alt=""> <span>Compare</span></a>
                                    </li>
                                    <li><a href="#"><img src="img/icon/search.png" alt=""></a></li>
                                </ul>
...
<script>
    // 368
    <%--function findById(rNo) {--%>

    <%--    fetch("${pageContext.request.contextPath}/rentalmytrack/Track.do").then(function(response){--%>
    <%--        return --%>
    <%--    })--%>
