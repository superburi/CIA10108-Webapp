<%@ page import="com.yu.rental.model.Rental" %><%--
...
<%
    ...
    pageContext.setAttribute("rental", rental);
%>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                                <div class="product__thumb__pic set-bg" data-setbg="${pageContext.request.contextPath}/template/malefashion-master/img/shop-details/thumb-1.png">
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">
                                <div class="product__thumb__pic set-bg" data-setbg="${pageContext.request.contextPath}/template/malefashion-master/img/shop-details/thumb-2.png">
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab">
                                <div class="product__thumb__pic set-bg" data-setbg="${pageContext.request.contextPath}/template/malefashion-master/img/shop-details/thumb-3.png">
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tabs-4" role="tab">
                                <div class="product__thumb__pic set-bg" data-setbg="${pageContext.request.contextPath}/template/malefashion-master/img/shop-details/thumb-4.png">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tabs-1" role="tabpanel">
                            <div class="product__details__pic__item">
                                <img src="${pageContext.request.contextPath}/template/malefashion-master/img/shop-details/product-big-2.png" alt="">
                            </div>
                        </div>
                        <div class="tab-pane" id="tabs-2" role="tabpanel">
                            <div class="product__details__pic__item">
                                <img src="${pageContext.request.contextPath}/template/malefashion-master/img/shop-details/product-big-3.png" alt="">
                            </div>
                        </div>
                        <div class="tab-pane" id="tabs-3" role="tabpanel">
                            <div class="product__details__pic__item">
                                <img src="${pageContext.request.contextPath}/template/malefashion-master/img/shop-details/product-big.png" alt="">
                            </div>
                        </div>
                        <div class="tab-pane" id="tabs-4" role="tabpanel">
                            <div class="product__details__pic__item">
                                <img src="${pageContext.request.contextPath}/template/malefashion-master/img/shop-details/product-big-4.png" alt="">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    <div class="product__details__text">
                        ...
                        <h3>${rental.rPrice} <span>7000.00</span></h3>
                        ...
                        <div class="product__details__btns__option">
                            <a href="#" onclick="addTrack()"><i class="fa fa-heart"></i> 加入追蹤</a>
